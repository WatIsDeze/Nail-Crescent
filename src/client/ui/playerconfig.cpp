...
void M_Menu_PlayerConfig(void)
{
    ...
    Vec3_Copy_(angles, m_player.entities[0].angles);
    Vec3_Copy_(origin, m_player.entities[0].origin);
    Vec3_Copy_(origin, m_player.entities[0].oldorigin);

    m_player.entities[1].flags = RF_FULLBRIGHT;
	m_player.entities[1].id = 2; // Q2RTX: add entity id to fix motion vectors
	Vec3_Copy_(angles, m_player.entities[1].angles);
    Vec3_Copy_(origin, m_player.entities[1].origin);
    Vec3_Copy_(origin, m_player.entities[1].oldorigin);
