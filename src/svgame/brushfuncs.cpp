...
void Brush_Move_Final(edict_t* ent)
{
    ...
    Vec3_Scale_(ent->moveinfo.dir, ent->moveinfo.remaining_distance / FRAMETIME, ent->velocity);
...
void Brush_Move_Begin(edict_t* ent)
{
    ...
    Vec3_Scale_(ent->moveinfo.dir, ent->moveinfo.speed, ent->velocity);
...
{
    Vec3_Clear(ent->velocity);
    Vec3_Subtract_(dest, ent->s.origin, ent->moveinfo.dir);
...
void Brush_AngleMove_Final(edict_t* ent)
{
    ...
    if (ent->moveinfo.state == STATE_UP)
        Vec3_Subtract_(ent->moveinfo.end_angles, ent->s.angles, move);
    else
        Vec3_Subtract_(ent->moveinfo.start_angles, ent->s.angles, move);
    ...
    Vec3_Scale_(move, 1.0 / FRAMETIME, ent->avelocity);
...
void Brush_AngleMove_Begin(edict_t* ent)
{
    ...
    if (ent->moveinfo.state == STATE_UP)
        Vec3_Subtract_(ent->moveinfo.end_angles, ent->s.angles, destdelta);
    else
        Vec3_Subtract_(ent->moveinfo.start_angles, ent->s.angles, destdelta);
    ...
    Vec3_Scale_(destdelta, 1.0 / traveltime, ent->avelocity);
...
void Think_AccelMove(edict_t* ent)
{
    ...
    Vec3_Scale_(ent->moveinfo.dir, ent->moveinfo.current_speed * 10, ent->velocity);
    ent->nextthink = level.time + FRAMETIME;
    ent->think = Think_AccelMove;
}