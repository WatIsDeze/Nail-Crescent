...
void Think_SpawnDoorTrigger(edict_t* ent)
{
    ...
    Vec3_Copy_(ent->absmin, mins);
    Vec3_Copy_(ent->absmax, maxs);
    ...
    other = G_Spawn();
    Vec3_Copy_(mins, other->mins);
    Vec3_Copy_(maxs, other->maxs);
    other->owner = ent;
...
void SP_func_door(edict_t* ent)
{
    ...
    Vec3_Copy_(ent->s.origin, ent->pos1);
    ...
    Vec3_MA_(ent->pos1, ent->moveinfo.distance, ent->movedir, ent->pos2);

    // if it starts open, switch the positions
    if (ent->spawnflags & DOOR_START_OPEN) {
        Vec3_Copy_(ent->pos2, ent->s.origin);
    ...
    Vec3_Copy_(ent->pos1, ent->moveinfo.start_origin);
    Vec3_Copy_(ent->s.angles, ent->moveinfo.start_angles);
    Vec3_Copy_(ent->pos2, ent->moveinfo.end_origin);
    Vec3_Copy_(ent->s.angles, ent->moveinfo.end_angles);
