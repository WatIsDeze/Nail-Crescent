...
void MoveClientToIntermission(edict_t *ent)
{
    ...
    Vec3_Copy_(level.intermission_origin, ent->s.origin);

    // N&C: FF Precision.
    Vec3_Copy_(level.intermission_origin, ent->client->ps.pmove.origin);
    //ent->client->ps.pmove.origin[0] = level.intermission_origin[0] * 8;
    //ent->client->ps.pmove.origin[1] = level.intermission_origin[1] * 8;
    //ent->client->ps.pmove.origin[2] = level.intermission_origin[2] * 8;
    Vec3_Copy_(level.intermission_angle, ent->client->ps.viewangles);
...
void BeginIntermission(edict_t *targ)
{
    ...
    Vec3_Copy_(ent->s.origin, level.intermission_origin);
    Vec3_Copy_(ent->s.angles, level.intermission_angle);
